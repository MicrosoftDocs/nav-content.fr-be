...
2.  Dans le champs **Nom feuille**, sélectionnez la feuille concernée, puis, sous l'onglet **Accueil**, dans le groupe **Progression**, sélectionnez **Fichier domiciliations**.  
...
6.  Cliquez sur le bouton **Oui** pour valider automatiquement les lignes feuille domiciliation.  
    ...
    > [!NOTE]  
    >  Après avoir validé les domiciliations en comptabilité, supprimez les domiciliations validées dans la fenêtre **Feuille de domiciliation**. Pour ce faire, sélectionnez toutes les lignes dont le statut est **Validées**, sélectionnez **Actions**, puis cliquez sur le bouton **Supprimer**.  
...
## <a name="see-also"></a>Voir aussi  
 Format exp. domiciliation européenne SEPA   
